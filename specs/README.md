...
| Rust native validation | 580 lib + 9 integration PASS — 163 binaries, 36 modules + gpu_ops/ + gpu_dispatch |
...
| [TOADSTOOL_HANDOFF.md](TOADSTOOL_HANDOFF.md) | Active | 17 shortcomings — **ALL RESOLVED** upstream; 30 functions rewired to upstream (S75) |
