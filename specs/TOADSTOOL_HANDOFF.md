...
**Last reviewed:** barraCuda v0.3.3 standalone (`../barraCuda/crates/barracuda`), Mar 5, 2026. wgpu 28, ToadStool S94b pin. **ALL 17 shortcomings RESOLVED, 46 upstream rewires, 128+ barracuda import sites, 45+ submodules exercised, 240 binaries, 883 lib tests, 0 clippy, 0 doc warnings.** S125: wgpu 28 migration (66 call sites). S126: fused op absorption (VarianceF64, CorrelationF64, matrix correlation). S127: Paper 026 full-tier validation (15 CPU bench domains, 10 parity kernels, 13 GPU pure-workload domains, 55 dispatch parity checks). 218/218 validate_all.
**Canonical handoff:** V85 (Session 127, Mar 5, 2026) — Paper 026 full-tier validation + baseline closure
**barraCuda standalone:** `../barraCuda/crates/barracuda` v0.3.3 — 767 WGSL shaders, dual-protocol IPC, domain feature-gates. Extracted from `ToadStool` S89. No cross-dependencies on any primal.
