...
| B3 | Good et al. "The dynamics of molecular evolution over 60,000 generations" Nature 551:45-50 | 2017 | LSTM+HMM+ESN allele trajectory classifier — classify allele fate (fixation/loss/polymorphic) | Module 3 (allele trajectories) | **COMPLETE** — Python baseline (`control/ltee_allele_trajectory/`) + Rust 16/16 PASS (`validate_ltee_b3_allele_trajectory`). 100% test accuracy (T06 ≥95%). S213/V169. |
| B4 | Blount et al. "Historical contingency and the evolution of a key innovation" PNAS 105:7899-7906 | 2008 | ESN early-warning classifier — detect potentiating mutations before citrate innovation | Module 4 (citrate structural) | **COMPLETE** — Python baseline (`control/ltee_citrate_esn/`) + Rust 16/16 PASS (`validate_ltee_b4_citrate_esn`). 94.3% test accuracy. S213/V169. |
