...
**Date**: May 17, 2026 (Session S211 — GPU Parity + Compute Dispatch Evolution. 6/6 science stages GPU-dispatchable (4 promoted CpuOnly→GpuPreferred). PCIe P2P in Dispatcher. Typed toadStool workload submission. 10 validation scenarios. 35 capabilities. 739 workspace tests (IPC-first) + 19 certification. V167 handoff)
