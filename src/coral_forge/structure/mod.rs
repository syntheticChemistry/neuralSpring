...
//! Structure prediction: rigid-body frame operations and Invariant Point Attention.
//!
//! Implements the Structure Module from `AlphaFold2` (Jumper et al. 2021,
//! Algorithm 22), now part of the coralForge engine:
//!
