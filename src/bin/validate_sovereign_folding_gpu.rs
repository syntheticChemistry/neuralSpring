...
//! nF-01 Phase B GPU: Sovereign folding Evoformer shader validation (df64 core streaming).
//!
...
//! pipeline are validated in `validate_sovereign_folding_gpu_pipeline`.
//!
...
//! ## Provenance
//!
//! CPU reference: `neural_spring::sovereign_folding`.
