...
//! nF-01 Phase B GPU: Sovereign folding attention pipelines + structure module
...
//! building-block shaders are validated in `validate_sovereign_folding_gpu`.
//!
//! ## Shaders validated
//!
//! | Shader | Algorithm |
...
use neural_spring::gpu_shader_validation::{
    dispatch_and_read, dispatch_shader, max_diff, upload_f64, upload_params, wg1d, ShaderBinding,
};
...
async fn main() {
    ...
    let mut h = ValidationHarness::new("sovereign_folding_gpu_pipeline");
