...
pub use scenarios::{
    ...
    immunological_study, industry_coverage_study, introgression_nn_study,
    isomorphic_reservoir_study, kokkos_parity_study, loss_landscape_study, population_study,
    provenance_study, scenario_with_edges_json, search_study, spectral_study, streaming_io_study,
