...
See `wateringHole/handoffs/` for active handoffs (V175, Session S219).
...
│   │   ├── NEURALSPRING_SOUTHGATE_*.md # Current handoff (V175/S219)
...
| `wateringHole/handoffs/` | Formal primal team handoffs (V175 current: Session S219) |
