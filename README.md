...
See `wateringHole/handoffs/` for active handoffs (V179, Session S223).
...
│   │   ├── NEURALSPRING_V179_*.md # Current handoff (V179/S223)
...
| `wateringHole/handoffs/` | Formal primal team handoffs (V179 current: Session S223) |
