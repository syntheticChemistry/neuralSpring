...
|---------|------|------|-------|
| **V83** | `handoffs/NEURALSPRING_TOADSTOOL_V83_S125_WGPU28_BARRACUDA_V033_SYNC_HANDOFF_MAR05_2026.md` | Mar 5, 2026 | S125: wgpu 22→28 migration (~70 API sites), `BarraCUDA` v0.3.1→v0.3.3, `ToadStool` S87→S94b pin, 871/880 lib (9 GPU upstream SIGSEGV), 0 clippy, 0 doc warnings. Supersedes V82 |
