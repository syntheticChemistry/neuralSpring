...
|---------|------|------|-------|
| **V125 absorption** | `handoffs/NEURALSPRING_V125_ECOSYSTEM_ABSORPTION_VALIDATION_SINK_CAST_DENY_HANDOFF_MAR24_2026.md` | Mar 24, 2026 | ValidationSink (5 sinks, 12 tests), cast deny (`cast_possible_truncation`/`cast_sign_loss`), 4 provenance integrity tests, deploy graph V124/S174, leverage guide refresh. 1,400+ tests. |
| **V125 cross-team** | `handoffs/NEURALSPRING_V125_CROSS_TEAM_EVOLUTION_HANDOFF_MAR24_2026.md` | Mar 24, 2026 | Full cross-team handoff: patterns we export (ValidationSink, upstream contract pinning, provenance integrity, cast deny), capabilities, integration surfaces for barraCuda/toadStool/coralReef/biomeOS/all springs. |
