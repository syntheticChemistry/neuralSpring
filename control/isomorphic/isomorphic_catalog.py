...
ARCHITECTURES = {
    "llama_7b": {
        ...
        "barracuda_mapping": {
            "embedding_lookup": "gather.wgsl",
            "qkv_projection": "gemm_f64.wgsl / gemv_q4.wgsl",
            "attention_scores": "attention.wgsl",
            "softmax": "(in attention.wgsl)",
            "attention_output": "mha_output.wgsl",
    ...
    "openfold_evoformer": {
        ...
        "barracuda_mapping": {
            "msa_row_attention": "attention.wgsl + bias",
            "msa_column_attention": "attention.wgsl (transposed)",
            "msa_transition": "gemm_f64.wgsl + relu",
            "outer_product_mean": "gemm_f64.wgsl (batched)",
            "pair_row_attention": "attention.wgsl",
            "pair_column_attention": "attention.wgsl",
            "pair_transition": "gemm_f64.wgsl + relu",
            "triangle_multiplication": "elementwise_mul_f64.wgsl + sum_reduce",
            "layer_norm": "layer_norm.wgsl",
        },
    },
    "resnet50": {
        ...
        "barracuda_mapping": {
            "conv2d": "conv2d.wgsl",
            "batch_norm": "batch_norm.wgsl",
            "relu": "nn::ReLU",
            "max_pool": "max_pool2d.wgsl",
            "avg_pool": "(reduction)",
    ...
    "vit_base": {
        ...
        "barracuda_mapping": {
            "patch_embedding": "conv2d.wgsl / gemm_f64.wgsl",
    ...
    "physics_surrogate_mlp": {
        ...
        "barracuda_mapping": {
            ...
            "gemm_output": "gemv_q4.wgsl (quantizable)",
            "relu": "nn::ReLU",
    ...
    "lstm_weather": {
        ...
        "barracuda_mapping": {
            ...
            "forget_gate": "lstm_cell.wgsl",
            "cell_gate": "lstm_cell.wgsl",
            "output_gate": "lstm_cell.wgsl",
...
PRIMITIVES = {
    "GEMM/GEMV": {
        ...
        "barracuda": ["gemm_f64.wgsl", "gemv_q4.wgsl", "gemv_q8.wgsl"],
    ...
    "Convolution": {
        ...
        "barracuda": ["conv2d.wgsl", "conv1d.wgsl", "depthwise_conv2d.wgsl"],
    ...
    "Gating": {
        ...
        "barracuda": ["lstm_cell.wgsl", "gru_cell.wgsl"],
