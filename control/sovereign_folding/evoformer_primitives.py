...
#
# Generates deterministic baselines for sovereign folding Phase B validation.
...
#
# Usage: python3 control/sovereign_folding/evoformer_primitives.py
# Output: control/sovereign_folding/evoformer_baselines.json
