...
**ToadStool**: **ALL 17 shortcomings RESOLVED** (S-01..S-17) | HEAD `f97fc2ae` (S79: Spring absorption, esn_v2, MultiHeadEsn, spectral extensions, jackknife/boltzmann bitcast fixes) | **44 upstream rewires** + 205 barracuda import files, 25+ submodules | V73 comprehensive handoff (paper queue + GPU pyramid)
