...
**ToadStool**: **ALL 17 shortcomings RESOLVED** (S-01..S-17) | S139 (`bfe7977b`), wgpu 28, BarraCUDA v0.3.3 | **46 upstream rewires** + 205 barracuda import files, 25+ submodules | V93 handoff (S139) | toadStool absorbed neuralSpring `pipeline_graph` (S139) + hotSpring `streaming_dispatch` | Compute triangle unblocked
