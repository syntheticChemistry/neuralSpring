...
**Status**: Migration complete — deprecated modules fossilized, S-03b resolved upstream, gpu_dispatch active (44 ops, ~97% GPU), 26 functions + 6 shader sources lean on upstream, CPU↔Python parity 39/39
